...
- **도착 시점 동기화 점멸 플래시 (Arrival-Synchronized Dual Flash Jump)**: TOC/미니맵 클릭 시 부드러운 스크롤이 목적지에 완전히 안착한 순간 에디터의 lashLine과 미리보기의 source-flash를 선명하게 펄스 재생 (Emil Kowalski 애니메이션 원칙)
